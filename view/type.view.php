      ...
      <div class="container">
        <div class="row">
          <div class="col-main col-sm-9 col-xs-12 col-sm-push-3">
            ...
            <div>
              <div class="shop-inner" id="new-product">
      ...
      if(!$(this).hasClass('checked')){
        ...
        $.ajax({
          ...
          success:function(responseFromPHP){
            if($('#new-product').hasClass('shop-inner')){
              $('#new-product').html(responseFromPHP)
              $('#new-product').removeClass('shop-inner')
            }
            else{
              $('#new-product').prepend(responseFromPHP)
            }
          },
          error:function(){
            console.log("error!!!")
